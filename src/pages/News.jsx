      ...
      <div className="py-20 bg-[#2e2d2c] px-[30px] md:px-0">
        <div className="max-w-[1580px] mx-auto">
          <div className="flex flex-col space-y-16">
            <div>
              <h3 className="text-[1.5625rem] md:text-5xl font-semibold text-white">
                Featured News
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {data.map((item) => (
                ...
                >
                  ...
                  />
                  <p className="text-white text-[.875rem] md:text-md font-light">
                    {item.date}
                  </p>
                  <h6 className="text-white font-semibold text-[1.125rem] md:text-2xl">
                    {item.title}
                  </h6>
                  <p className="text-[#cbcbcb] font-medium text-[.875rem] md:text-sm">
                    {item.subtitle}
                  </p>
                </div>
              ))}
        ...
        <div className="max-w-[1580px] mx-auto">
          <div className="flex flex-col space-y-14 px-[30px] md:px-0">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <h3 className="text-[1.5625rem] md:text-5xl font-semibold text-black">
                All News
              </h3>
              <form className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-20">
                <div className="flex space-x-6 md:space-x-0 items-center">
                  <Input
                    styles="flex flex-col items-start md:space-x-3 md:items-center md:flex-row"
                    label="From"
                    type="date"
                    name="bday"
                  />
