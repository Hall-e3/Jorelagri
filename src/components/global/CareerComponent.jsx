        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          ...
          <div className="flex flex-col space-y-3">
            <p className="text-xl font-light leading-1 text-black">
              Our distinctive culture is underpinned by our five core values and
              finessed with influences from our 9,500+ strong multicultural
              team. We celebrate our differences and value inclusivity and
              equality.
            </p>
            <p className="text-xl font-light leading-1 text-black">
              We offer you the chance to learn from skilled colleagues, and
              through formal programmes – providing the opportunities to develop
              your own skills and knowledge, and to explore personal and
              professional passions through your role and a variety of projects.
            </p>
            <p className="text-xl font-light leading-1 text-black">
              We value collaboration, not just internally but through the
              relationships we build with partners and customers. It’s not about
              individual glory, it’s about achieving shared goals – although we
              are quick to recognise a job well done!
            </p>
            <p className="text-xl font-light leading-1 text-black">
