    ...
    <div className="pt-115 md:py-20 bg-[#2e2d2c]">
      <div className="max-w-[1580px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 relative">
          ...
          <div className="flex flex-col items-center mb-[-1.875rem]  py-[1.5625rem]  px-[1.25rem] justify-start md:justify-center h-[30.1875rem] max-w-[19.6875rem] bg-white shadow-lg rounded-bl-[1.875rem] rounded-tr-[1.875rem] absolute bottom-100 left-10 md:bottom-0 md:left-0 w-full md:top-40 md:right-0 z-1">
